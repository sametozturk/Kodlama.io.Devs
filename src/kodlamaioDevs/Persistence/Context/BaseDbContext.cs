...
namespace Persistence.Context
{
    public class BaseDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Language[] languageEntitySeeds = { new(1, "C#"), new(2, "Java"), new(3, "Javascript"), new(4, "Python") };
            modelBuilder.Entity<Language>().HasData(languageEntitySeeds);

            Technology[] technologyEntitySeeds = { new(1, 1, "WPF"), new(2, 1, "ASP.NET"), new(3, 2, "Spring"), new(4, 2, "JSP"), new(5, 3, "React"), new(6, 3, "Vue") };
