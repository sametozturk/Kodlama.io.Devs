...
using Application.Features.OperationClaims.Queries.GetListClaim;
...
namespace WebAPI.Controllers
{
    ...
    public class OperationClaimsController : BaseController
    {
        ...
        {
            GetListOperationClaimQuery getListOperationClaimQuery = new() { PageRequest = pageRequest }; /*new GetListBrandQuery() { PageRequest=pageRequest};*/
